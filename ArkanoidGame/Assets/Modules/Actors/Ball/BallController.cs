...
public class BallController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        {
            rb.linearVelocity = velocity.normalized * minTotalSpeed;
        }
    }
    ...
    public void SpawnAsClone(Vector2 position, Vector2 velocity)
    {
        ...
        rb.linearVelocity = velocity.normalized * _currentSpeed;
    }
    ...
    public void ActivateSpeedBoost()
    {
        ...
        if (isLaunched) rb.linearVelocity = rb.linearVelocity.normalized * _currentSpeed;
    }
